...
public class HomeStaff extends javax.swing.JFrame {
    ...
    public HomeStaff(String username, String role) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(HomeStaff.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
        mainPanel.repaint();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String username = "";
                String role = "";
                new HomeStaff(username, role).setVisible(true);
            }
        });
    }
